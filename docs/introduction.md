...
In other modules, all abstract classes related to physical objects are subclasses of `PrintableObject`. A mature subclass needs to define its own **modifiable\_properties** class attribute, which can be used in class method `cls.filter_properties(propdict)` to filter modifiable physical properties in the `dict`, <span class="attr" style="color:red;">kwargs</span>. In general, **modifiable\_properties** contains the names of all input parameters defined in the constructor of the subclass, other than the <span class="attr" style="color:red;">name</span>.

An empty **property\_set** is created if the subclass is constructed. It is a data type similar to the python `dict`. One can get and set the <span class="attr" style="color:red;">value</span> corresponding to <span class="attr" style="color:red;">key</span> by `value = property_set[key]` and `property_set[key] = value`. The private attribute **\_\_required_props** of **property_set** is a set, when an instance of `PropertySet` is created, this attribute will be set to `set(props)` where <span class="attr" style="color:red;">props</span> is the input parameter of the constructor <span class="attr" style="color:red;">\_\_init\_\_(props=(), \*args, \*\*kwargs)</span>. **\_\_required\_props** contains all basic properties that a physical object must have, and all other properties can be derived from these basic properties. These basic properties are initialized to `None`. The value of a property `prop` in **\_\_required_props** can be normally obtained through `property_set[prop]`, but if the value of this property is `None`, obtaining the corresponding value through `property_set.get_strictly(prop)` will raise a `PropertyLost` exception.
...
- <span class="attr" style="color:red;">\_\_init\_\_(name="Object", \*\*kwargs)</span> - Create an instance of `Object`, the name is set to be <span class="attr" style="color:red;">name</span>. In <span class="attr" style="color:red;">kwargs</span>, only the key name consistent with the property name in <span class="attr" style="color:red;">modifiable\_properties</span> will be set.
  
- <span class="attr" style="color:red;">get\_property(k, v_f=None)</span> - Use the property name <span class="attr" style="color:red;">k</span> to get the property value saved in the <span class="attr" style="color:red;">property\_set</span>. If the property does not exist, use the function <span class="attr" style="color:red;">v\_f</span> to calculate its value and save it in the <span class="attr" style="color:red;">property\_set</span>. Then this method use <span class="attr" style="color:red;">get\_strictly</span> of `PropertySet` to get the value of this property. Usually we don't use this method directly, but define a method decorated with `@property` in the subclass, and call the <span class="attr" style="color:red;">get\_property</span> in this method.
  
- <span class="attr" style="color:red;">get\_proplist()</span> - Get all the method names decorated with `@property` in the class. It is a concrete implementation of an abstract method <span class="attr" style="color:red;">get\_proplist</span> in `PrintInfoMixin`. 
  
- <span class="attr" style="color:red;">change\_params(\_filter=True, \*\*kwargs)</span> - This method is used to modify the value of parameters in <span class="attr" style="color:red;">property\_set</span>. Inside the method, it will call <span class="attr" style="color:red;">filter\_properties</span> if <span class="attr" style="color:red;">\_filter</span> is `True`, then it  will call <span class="attr" style="color:red;">preprocess\_properties</span> to pre-process the properties, then it will call <span class="attr" style="color:red;">update\_propset</span> to update the property\_set, and finally it will call <span class="attr" style="color:red;">postprocess\_properties</span> to post-process the properties. 
...
- <span class="attr" style="color:red;">\_\_required_props</span> - `set` object, contains all the names of the necessary properties. All the other properties not in <span class="attr" style="color:red;">\_\_required_props</span> will be cleared when the <span class="attr" style="color:red;">change_params</span> method of this class is called, see <span class="attr" style="color:red;">change\_params</span> for more details. Only <span class="attr" style="color:red;">reset\_required</span>, <span class="attr" style="color:red;">add\_required</span>, <span class="attr" style="color:red;">del\_required</span>, and <span class="attr" style="color:red;">clear\_required</span> can modify <span class="attr" style="color:red;">\_\_required\_props</span>.

<p style="color:blue;">The methods are defined as follows:</p>

- <span class="attr" style="color:red;">\_\_init\_\_(required\_props=(), *args, **kwargs)</span> - Create an instance of `PropertySet`. The <span class="attr" style="color:red;">required\_props</span> is used to set the attribute <span class="attr" style="color:red;">\_\_required\_props</span> of this instance. And <span class="attr" style="color:red;">args</span>, <span class="attr" style="color:red;">kwargs</span> are parameters which are consistent with the input parameters of python's `dict`.

- <span class="attr" style="color:red;">get\_strictly(key, default=None)</span> - Similar to method `get(key, default=None)` provided by `collections.UserDict`. But if <span class="attr" style="color:red;">key</span> is a property in <span class="attr" style="color:red;">\_\_required\_props</span> and the value of this property is `None`, then a `PropertyLost` exception will be raised.

- <span class="attr" style="color:red;">change\_params(**kwargs)</span> - This method updates the value of properties in the instance, and all saved properties except the properties in <span class="attr" style="color:red;">\_\_required\_props</span> will be deleted. 

- <span class="attr" style="color:red;">reset\_required(props=())</span> - Reset <span class="attr" style="color:red;">\_\_required\_props</span> by <span class="attr" style="color:red;">props</span>, where <span class="attr" style="color:red;">props</span> must be an iterable object containing the necessary properties.

- <span class="attr" style="color:red;">add\_required(props=())</span> - If <span class="attr" style="color:red;">props</span> is of type `str`, add this as a necessary property to <span class="attr" style="color:red;">\_\_required\_props</span>; if <span class="attr" style="color:red;">props</span> is an iterable object with elements of `str` type, add these elements Into <span class="attr" style="color:red;">\_\_required\_props</span>.

- <span class="attr" style="color:red;">del\_required(props=())</span> - If <span class="attr" style="color:red;">props</span> is of type `str`, remove this element from <span class="attr" style="color:red;">\_\_required\_props</span>; if <span class="attr" style="color:red;">props</span> is an iterable object with elements of `str` type, remove these elements from <span class="attr" style="color:red;">\_\_required\_props</span>. If the element is not a member, do nothing.

- <span class="attr" style="color:red;">clear\_required()</span> - Remove all elements from <span class="attr" style="color:red;">\_\_required\_props</span>.
